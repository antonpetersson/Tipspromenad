...
class Question{
    ...
    function printQuestion(){
        ...
        echo '<td>';
        echo '1 <input type="radio" name="options' . $this->id . '" value="answer1">' . $this->answer1;
        echo '</td></tr><tr><td>';
        echo 'X<input type="radio" name="options' . $this->id . '" value="answerX">' . $this->answerX;
        echo '</td></tr><tr><td>';
        echo '2 <input type="radio" name="options' . $this->id . '" value="answer2">' . $this->answer2;
        echo '</td></tr>';
